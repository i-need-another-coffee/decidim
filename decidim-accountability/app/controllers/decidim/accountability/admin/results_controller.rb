    ...
    module Admin
      ...
      class ResultsController < Admin::ApplicationController
        ...
        def collection
          ...
          @collection ||= Result.includes(:taxonomies, :status, :parent, :component).where(component: current_component, parent_id:).page(params[:page]).per(15).order(created_at: :asc)
        end
