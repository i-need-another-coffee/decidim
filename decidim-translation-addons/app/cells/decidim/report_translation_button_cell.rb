...
module Decidim
  class ReportTranslationButtonCell < ButtonCell
    ...
    def report_form
      @report_form ||= user_reportable? ? Decidim::ReportTranslationForm.from_params(reason: "wrong_translation") : Decidim::ReportTranslationForm.new(reason: "wrong_translation")
    end
