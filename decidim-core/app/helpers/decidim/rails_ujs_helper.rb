  ...
  module RailsUjsHelper
    def link_to(name = nil, options = nil, html_options = nil, &block)
      ...
      if html_options["data-confirm"]
        html_options["data-turbo-confirm"] = html_options["data-confirm"]
        html_options.delete("data-confirm")
        Rails.logger.warn "RailsUJS: data-confirm is deprecated, use data-turbo-confirm instead"
      end
