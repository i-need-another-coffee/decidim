  ...
  module Headers
    describe "ContentSecurityPolicy" do
      ...
      it "sets the appropriate headers" do
        ...
        expect(response.headers["Content-Security-Policy"]).to include("script-src 'self' 'unsafe-eval' localhost:* #{organization.host}:*; ")
      ...
      context "when content policy is added by organization" do
        ...
        it "sets the appropriate headers" do
          ...
          expect(response.headers["Content-Security-Policy"]).to include("script-src 'self' 'unsafe-eval' https://script.example.org;")
      ...
      context "when content policy is added via decidim config" do
        it "sets the appropriate headers" do
          ...
          expect(response.headers["Content-Security-Policy"]).to include("script-src 'self' 'unsafe-eval' https://script.example.org localhost:* #{organization.host}:*; ")
