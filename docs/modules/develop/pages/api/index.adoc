...
*** xref:develop:api/reference/attachment_collection.adoc[Attachment Collections]
**** xref:develop:api/reference/attachment_collection/create.adoc[Create Attachment Collection]
**** xref:develop:api/reference/attachment_collection/update.adoc[Update Attachment Collection]
**** xref:develop:api/reference/attachment_collection/delete.adoc[Delete Attachment Collection]
*** xref:develop:api/reference/attachments.adoc[Attachments]
**** xref:develop:api/reference/attachments/create.adoc[Create Attachments]
**** xref:develop:api/reference/attachments/update.adoc[Update Attachments]
**** xref:develop:api/reference/attachments/delete.adoc[Delete Attachments]
*** xref:develop:api/reference/file_upload.adoc[File Upload]
**** xref:develop:api/reference/upload/file.adoc[Upload File]
**** xref:develop:api/reference/upload/blob.adoc[Delete Blob]
