...
Gem::Specification.new do |s|
  ...
  s.add_dependency "rubocop-faker", "~> 1.2.0"
  s.add_dependency "rubocop-performance", "~> 1.23.0"
  s.add_dependency "rubocop-rails", "~> 2.27.0"
  s.add_dependency "rubocop-rspec", "~> 3.3.0"
