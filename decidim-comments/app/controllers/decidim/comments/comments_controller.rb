    ...
    class CommentsController < Decidim::Comments::ApplicationController
      ...
      def index
        ...
        if commentable.is_a?(Decidim::Comments::Comment)
          @comments = commentable.descendants.to_a
        ...
        @comments = @comments.includes(:up_votes, :down_votes, :root_commentable, :commentable, :moderation, author: [ :organization, :avatar_attachment ]).reject do |comment|
