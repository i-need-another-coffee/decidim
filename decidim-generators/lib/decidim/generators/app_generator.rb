  ...
  module Generators
    ...
    class AppGenerator < Rails::Generators::AppGenerator
      ...
      class_option :repository, type: :string,
                                default: "https://github.com/i-need-another-coffee/decidim.git",
...
# https://docs.decidim.org/en/develop/customize/content_security_policy)
      ...
      def repository
        @repository ||= options[:repository] || "https://github.com/i-need-another-coffee/decidim.git"
      end
      ...
      def target_gemfile
        root = if options[:path]
                 ...
                 "https://raw.githubusercontent.com/i-need-another-coffee/decidim/#{branch}/decidim-generators"
               else
                 root_path
               end
