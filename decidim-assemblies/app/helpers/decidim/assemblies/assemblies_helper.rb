        ...
        [
          *(if participatory_space.members.not_ceased.any?
              [{
                ...
                url: decidim_assemblies.assembly_assembly_members_path(participatory_space, locale: current_locale),
                active: is_active_link?(decidim_assemblies.assembly_assembly_members_path(participatory_space, locale: current_locale), :inclusive)
              }]
            end
           )
